...
function draw() {
   ...
   //Con esto cuento hombres y mujeres muertos en PRIMERA clase
...
//Con esto cuento hombres y mujeres muertos en SEGUNDA clase
for(var c= 0; c < data.getRowCount(); c++) {
  if ((data.get(c,1) == 0) && (data.get(c,5) == "male") && (data.get(c,2) == 2)) {
   ...
   //Con esto cuento hombres y mujeres muertos en TERCERA clase
   for(var c= 0; c < data.getRowCount(); c++) {
   ...
   print("Murieron " + muerta_en_primera + " mujeres y " + muerto_en_primera + " hombres en primera clase.");
   print("Murieron " + muerta_en_segunda + " mujeres y " + muerto_en_segunda + " hombres en segunda clase.");
   print("Murieron " + muerta_en_tercera + " mujeres y " + muerto_en_tercera + " hombres en tercera clase.");
